        ...
        if st.session_state["fx_running"]:
            ...
            if df_ap.empty or len(df_ap) < 30:
                ...
                if strategy == "MA 크로스":
                    ...
                    ma20b = cast(Any, close.rolling(20).mean())
                    std20 = cast(Any, close.rolling(20).std())
